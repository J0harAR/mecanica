  ...
  <table>
        ...
        <tbody>
            @foreach ($prestamos as $docente)
                @foreach ($docente->herramientas as $herramienta)
                    <tr>
                        <td>{{ $herramienta->pivot->id }}</td>
                        <td>{{ $docente->rfc }}</td>
                        <td>{{ $docente->persona->nombre }}</td>
                        <td>{{ $docente->persona->apellido_p }} {{$docente->persona->apellido_m}}</td>
                        <td>{{ $herramienta->pivot->fecha_prestamo }}</td>
                        <td>{{ $herramienta->pivot->fecha_devolucion }}</td>
                        <td>{{ $herramienta->pivot->estatus }}</td>
