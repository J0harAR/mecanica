...
@can('ver-usuarios')
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('crear-usuarios')
                <a href="{{ route('usuarios.create') }}" class="btn btn-tecnm  hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="card-body p-4">
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered shadow-sm rounded align-middle"
                        ...
                        <thead class="bg-primary text-white" style="z-index: 1;">
                            <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('usuarios.destroy', $usuario->id) }}" method="POST">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-danger rounded-pill shadow-sm">Eliminar</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
