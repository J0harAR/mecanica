...
@can('ver-asignaturas')
  ...
  @endcan
    ...
    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
      data-bs-target="#modal-{{ $asignatura->clave }}">
  ...
  @endcan
      ...
      <!-- Modal -->
      <div class="modal fade" id="modal-{{ $asignatura->clave }}" tabindex="-1"
      ...
      <div class="modal-content">
        ...
        ¿Estás seguro que quieres eliminar la asignatura: {{ $asignatura->nombre }}?
        </div>
