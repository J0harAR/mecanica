      ...
      <form class="row g-3 needs-validation" action="{{ route('roles.update', $role->id) }}" method="POST">
        ...
        <div class="col-12">
          ...
          $permissions = [
              ...
              'Maquinarias' => ['ver-maquinarias', 'crear-maquinaria', 'editar-maquinaria', 'asignar-insumos-maquinaria','desasignar-insumos-maquinaria','borrar-maquinaria'],
              'Mantenimientos' => ['ver-mantenimientos', 'crear-mantenimiento'],
              ...
              'Prestamos' => ['ver-prestamos', 'crear-prestamo', 'editar-prestamo','finalizar-prestamo'],
